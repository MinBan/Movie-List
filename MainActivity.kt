...
import com.example.movielistgit.R
...
{
    // the MovieDataBase API key to new application
    private static final String API_KEY = <a07e22bc18f5cb106bfe4cc1f83ad8ed>;

    // number of movies to a single request to web server
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        searchButton.setOnClickListener(new OnClickListener()
        {
            ...
            {
                new RequestTask().execute("https://developers.themoviedb.org/3/movies/get-movie-details" + API_KEY + "&q=" + searchBox.getText().toString().trim() + "&page_limit=" + MOVIE_PAGE_LIMIT);
            }
        });
